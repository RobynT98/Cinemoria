    ...
    <section className="p-4 space-y-4">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-sand-300 text-sm">
              Lägg till en film, sök bland din samling eller bygg en lista.
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            ...
            <Link to="/movie/search" className="btn">Sök</Link>
            <Link to="/movie/collections" className="btn">Skapa lista</Link>
          </div>
        </div>
      </div>
      ...
      <section>
        <div className="flex items-center justify-between">
          ...
          {recent.length > 0 && (
            <Link to="/movie/search" className="text-sm hover:underline">Visa fler</Link>
          )}
        </div>
