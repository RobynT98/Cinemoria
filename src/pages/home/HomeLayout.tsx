    ...
    <div className="scope-home min-h-full flex flex-col">
      ...
      >
        <div className="max-w-3xl mx-auto px-3 py-3">
          <h1 className="text-xl font-semibold">Hem</h1>
          <nav className="mt-2 flex gap-2 overflow-x-auto scrollbar-none">
            <Tab to="." label="Översikt" icon={<HomeIcon size={16} />} />
            <Tab to="instructions" label="Instruktioner" icon={<HelpCircle size={16} />} />
          </nav>
        </div>
      </header>
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        clsx(
          ...
          isActive
            ? "tab-active" // använder var(--accent) från .scope-home
